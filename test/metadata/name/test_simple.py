...
class TestSimplePersonName(unittest.TestCase):

    @classmethod
    def setUpClass(cls):
        global SimplePersonName, NameField, FieldModifier
        from musculus.metadata.name import FieldModifier, NameField, SimplePersonName
